...
<head>
<meta charset="utf-8">
<title>Huminity HTML Template | Blog</title>
<!-- Stylesheets -->
                ...
                <div class="content-side col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="news-block">
                        <div class="inner-box">
                            ...
                            <div class="lower-box">
                                <h3><a href="blog-single.html">Child Education in South-Africa!!</a></h3>
                                <div class="text">At the same time, Rahul Roy Chowdhury took charge of Google team that overes qulaity check and here will. Chrome, the company’s web browser.remember the ‘Web is Dead’ article very clearly remembers. “I thought: ‘Oh My God. I’ve made a hu mistake.'” Needless to say, he didn’t really believe that...</div>
                                <ul class="post-meta">
                                    <li><span class="icon fa fa-comment-o"></span>13</li>
                                    <li><span class="icon fa fa-heart-o"></span>128</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                	...
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget popular-posts">
                            ...
                            <article class="post">
                                ...
                                <div class="text"><a href="blog-single.html">No Hunger in South Africar</a></div>
                                <a href="causes-single.html" class="detail">See Details <span class="icon fa fa-angle-right"></span></a>
                            </article>

                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-single.html"><img src="images/resource/post-thumb-2.jpg" alt=""></a></figure>
                                <div class="text"><a href="blog-single.html">Clean Water For Every Child</a></div>
                                <a href="causes-single.html" class="detail">See Details <span class="icon fa fa-angle-right"></span></a>
                            </article>
                            
                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-single.html"><img src="images/resource/post-thumb-3.jpg" alt=""></a></figure>
                                <div class="text"><a href="blog-single.html">Collect Winter Cloths For..</a></div>
                                <a href="causes-single.html" class="detail">See Details <span class="icon fa fa-angle-right"></span></a>
                            </article>
