...
<!--<link href="resources/css/color-themes/orange-theme.css" rel="stylesheet">-->
...
<div class="page-wrapper">
    	...
    	<div class="header-top">
        	<div class="auto-container">
            	<div class="clearfix">
                    <div class="top-left">
                        <ul class="clearfix">
                        	<li><span class="icon fa fa-phone"></span> (880) 172 380 956</li>
                        	<li><span class="icon fa fa-envelope"></span> huminityus@gmail.com</li>
                            <li><span class="icon fa fa-clock-o"></span> Mon-Sat:  8:00am-6:30pm</li>
                    ...
                    <div class="top-right clearfix">
                    	...
                    	<!--Cart Box-->
                        <a href="shop.html" class="cart-box"><span class="icon flaticon-shopping-bag"></span> (0)</a>
                    </div>
                </div>
            </div>
        </div>
            	...
            	<div class="clearfix">
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="donate-btn">
                        	<a class="donate theme-btn" href="donate.html">Donate Now</a>
                        </div>
    ...
    <section class="title-section">
    	<div class="auto-container">
        	<div class="text">Huminity is the <span class="theme_color">world’s #1</span> fundraising site forcharitable causes. Raise money for over 1.5 million charities, marathons, events and employee giving.</div>
        </div>
    </section>
    <!--End Title Section-->
    	...
    	<div class="auto-container">
        	<div class="row clearfix">
            	...
            	<div class="about-column-two col-md-6 col-sm-12 col-xs-12">
                	<div class="inner-box">
                        <h2>Who We are</h2>
                        <div class="text">Lorem ipsum dolor sit amet, vis probo mediocritatem ne. Qui muciusreferrentur eu, ea sea quem dicit theophrastus. Sale justo detraxit eu usu. No nec perpetua sententiae. Laoreet antiopam principes ne eam. </div>
                        <ul class="list-style-two">
                        	<li>Lorem ipsum dolor sit amet, usu an quem augue admodum.</li>
                            <li>Lorem ipsum dolor sit amet, duo in atqui omnesque praesent. Vix</li>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="author-info pull-left">
                                ...
                                <h4>Jhone Michale</h4>
                                <div class="designation">CEO & Founder of CharityPro</div>
                            </div>
            	...
            	<div class="row clearfix">
                    ...
                    <div class="services-style-two col-md-4 col-sm-6 col-xs-12">
                    	<div class="inner-box">
                            ...
                            <div class="title">Work Since 1987 with Pride!!</div>
                            <div class="text">Raise more money with our custom made solution. Unlimited campai pages pledge giving, monthly giving.</div>
                        </div>
                    </div>
                    ...
                    <div class="services-style-two col-md-4 col-sm-6 col-xs-12">
                    	<div class="inner-box">
                            ...
                            <div class="title">Mission to make smile the world</div>
                            <div class="text">Raise more money with our custom made solution. Unlimited campai pages pledge giving, monthly giving.</div>
                        </div>
                    </div>
                    ...
                    <div class="services-style-two col-md-4 col-sm-6 col-xs-12">
                    	<div class="inner-box">
                            ...
                            <h2><a href="#">Large Community</a></h2>
                            <div class="title">Join our community & help others</div>
                            <div class="text">Raise more money with our custom made solution. Unlimited campai pages pledge giving, monthly giving.</div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="column counter-column wow fadeIn col-md-3 col-sm-6 col-xs-12" data-wow-delay="0ms" data-wow-duration="0ms">
                            <div class="inner">
                                ...
                                <div class="count-outer count-box">
                                    ...
                                    <span class="count-text" data-speed="8000" data-stop="85873">0</span>
                                    <span class="plus-tag">+</span>
                                </div>
                                <h4 class="counter-title">Total Donation</h4>
                            </div>
                        </div>
                        ...
                        <div class="column counter-column wow fadeIn col-md-3 col-sm-6 col-xs-12" data-wow-delay="0ms" data-wow-duration="0ms">
                            <div class="inner">
                                ...
                                <div class="count-outer count-box">
                                	<span class="dollor-sign">$</span>
                                    <span class="count-text" data-speed="6000" data-stop="38630">0</span>
                                </div>
                                <h4 class="counter-title">Total Fundrising</h4>
                            </div>
                        </div>
    ...
    <section class="team-section">
    	<div class="auto-container">
            ...
            <div class="sec-title centered">
                <h2>Our Volunteer</h2>
                <div class="text">No matter how many times your amazing, absolutely brilliant </div>
            </div>
            <div class="row clearfix">
            	...
            	<div class="team-member col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="lower-box">
                        	<h3>Antonio Creighton</h3>
                            <div class="designation">Senior Volunteer</div>
                        </div>
                    </div>
                </div>
            	...
            	<div class="team-member col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="lower-box">
                        	<h3>Rashed kabir Abs</h3>
                            <div class="designation">Head of Volunteer</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="testimonial-outer">
                ...
                <div class="client-testimonial-carousel owl-carousel owl-theme">
                    ...
                    <div class="testimonial-block-one">
                        <div class="inner-box">
                            <div class="text">Aristotle maintained the sharp distinct between science and the practical knowledge of artisans, treating theoretical speculation as the highest type of human activity, practical thinking about good living as something less lofty, and the knowledge</div>
                        </div>
                    </div>
    ...
    <section class="call-to-action-section" style="background-image:url(images/background/2.jpg);">
    	<div class="auto-container">
            ...
            <div class="text">Join with us and become real human being and make the world  smile !!</div>
